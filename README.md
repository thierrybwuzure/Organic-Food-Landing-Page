...
- **Farm Showcase**: Interactive galleries featuring local farms
- **Product Cards**: Beautiful pricing cards for organic products
...
```bash
git clone https://github.com/thierrybwuzure/Landing-Page.git
```
...
├── images/             # Image assets
│   ├── logoMishMash.jpeg
│   ├── logoFermeDeLaWarde.jpg
│   ├── logoFermeDeLaFalize.jpg
│   ├── mishMash1.jpg
│   ├── mishMash2.jpg
│   ├── mishMash3.jpg
│   ├── mishMash4.jpg
│   ├── laFalizeFraises1.jpg
│   ├── laFalizeFraises2.jpg
│   └── laFalizeFraises3.jpg
